...
List<List<ProductsModel>> productsModelFromJson(String str) => List<List<ProductsModel>>.from(json.decode(str).map((x) => List<ProductsModel>.from(x.map((x) => ProductsModel.fromJson(x)))));

String productsModelToJson(List<List<ProductsModel>> data) => json.encode(List<dynamic>.from(data.map((x) => List<dynamic>.from(x.map((x) => x.toJson())))));
