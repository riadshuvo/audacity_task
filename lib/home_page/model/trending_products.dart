...
List<List<TrendngProductsModel>> trendngProductsModelFromJson(String str) => List<List<TrendngProductsModel>>.from(json.decode(str).map((x) => List<TrendngProductsModel>.from(x.map((x) => TrendngProductsModel.fromJson(x)))));

String trendngProductsModelToJson(List<List<TrendngProductsModel>> data) => json.encode(List<dynamic>.from(data.map((x) => List<dynamic>.from(x.map((x) => x.toJson())))));

class TrendngProductsModel {
  String? slNo;
  String? productName;
  String? shortDetails;
  ...
  TrendngProductsModel.fromJson(Map<String, dynamic> json) {
    slNo = json['slNo'];
