                    ...
                    children: [
                                ...
                                SingleChildScrollView(
                                    ...
                                    child: Row(
                                      ...
                                      children: List.generate(
                                        state.trendingList!.first.length,
                                        (index) => TrendingSellers(
                                            trendingSellerModel: state
                                                .trendingList!.first[index]),
                                      ),
                                    )),
                              ],
                            ),
                                ...
                                SingleChildScrollView(
                                    ...
                                    child: Row(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      children: List.generate(
                                        state.trendingProductList!.first.length,
                      ...
                      Container(
                        ...
                        child: Container(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: List.generate(
                                state.productList!.first.length, (index) {
                              if (index >= 0 && index <= 2) {
                                return ProductsUi(
                                  productsModel:
                                  state.productList!.first[index],
                                );
                              } else {
                                return Container();
                              }
                                ...
                                SingleChildScrollView(
                                    ...
                                    child: Row(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      children: List.generate(
                                        state.newArrivalList!.first.length,
                                        (index) => NewArrivals(
                                            newArrivalsModel: state
                                                .newArrivalList!.first[index]),
                                      ),
                                    )),
                              ],
                            ),
                      ...
                      Container(
                        ...
                        child: Container(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: List.generate(state.productList!.first.length,
                                    (index) {
                                      if (index >= 3 && index <= 5) {
                                        return ProductsUi(
                                          productsModel:
                                ...
                                SingleChildScrollView(
                                    ...
                                    child: Row(
                                      crossAxisAlignment:
                                          CrossAxisAlignment.start,
                                      children: List.generate(
                                        state.newShopList!.first.length,
                                        (index) => NewShops(
                                            newShops: state
                                                .newShopList!.first[index]),
                                      ),
                                    )),
                              ],
                            ),
                      ...
                      Container(
                        ...
                        child: Container(
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: List.generate(state.productList!.first.length, (index) {
                              if (index >= 6) {
                                return ProductsUi(
                                  productsModel:
                                  state.productList!.first[index],
